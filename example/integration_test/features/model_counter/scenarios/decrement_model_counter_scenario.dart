...
class DecrementModelCounterScenario extends IntegrationScenario {
          ...
          steps: [
            ...
            And(
              ...
              (tester, log, [example, binding, result]) async {
                ...
                final value = find.byKey(ConstKeys.valueOfTheModelCounter);
            ...
            When(
              ...
              (tester, log, [example, binding, result]) async {
                ...
                final button =
                    find.byTooltip(ConstTooltips.decrementModelCounter);
